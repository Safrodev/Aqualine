...
public class FishingAttributes {
    ...
    public static final Holder<Attribute> FISHING_SPEED = ATTRIBUTES.register("fishing_speed", () -> new RangedAttribute("aqualine.fishing_speed", 0.0, 0.0, 1024.0).setSyncable(true));
