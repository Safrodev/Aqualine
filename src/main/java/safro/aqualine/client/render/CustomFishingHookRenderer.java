...
public class CustomFishingHookRenderer extends EntityRenderer<CustomFishingHook> {
    ...
    @Override
    public void render(CustomFishingHook entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(CustomFishingHook entity) {
